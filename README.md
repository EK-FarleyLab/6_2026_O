...
All software dependencies and operating systems (including version numbers) can be found in the `required_pkg.txt`. The code has been tested with these packages. Other version may or may not work. There is no other hardware required.
